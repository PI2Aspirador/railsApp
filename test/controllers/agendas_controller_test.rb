...
class AgendasControllerTest < ActionController::TestCase
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post :create, agenda: { description: @agenda.description, end_time: @agenda.end_time, start_time: @agenda.start_time, title: @agenda.title }
    end
  ...
  test "should update agenda" do
    patch :update, id: @agenda, agenda: { description: @agenda.description, end_time: @agenda.end_time, start_time: @agenda.start_time, title: @agenda.title }
    assert_redirected_to agenda_path(assigns(:agenda))
  end
